...
#### Scenario: Close Fullscreen Image Viewer via Back Button
- **WHEN** the user initiates a system back navigation gesture/button press while the Fullscreen Image Viewer is active
- **THEN** the application dismisses the overlay and returns to the Swipe Screen interface.
...
#### Scenario: Dismiss Kept Photo Zoom via Back Button
- **WHEN** the user initiates a system back navigation gesture/button press while the Fullscreen Image Viewer is active on the Kept Photos screen
- **THEN** the application dismisses the overlay and returns to the Kept Photos grid/album view.
